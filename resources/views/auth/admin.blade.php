       ...
       <div class="col-12 col-lg-4">
          <div class="p-5 bg-light rounded ">
            ...
            <form action="{{ route('login.admin') }}" method="post">
                @csrf
                <fieldset>
                    <input id="email" type="text" class="inputform @error('email') is-invalid @enderror form-control mb-3" name="email"
                        value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="e-mail">

                    <input id="password" type="password" class="inputform @error('password') is-invalid @enderror form-control mb-3" name="password"
